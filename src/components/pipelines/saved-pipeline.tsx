...
export function SavedPipeline({
  ...
  return (
    <div
      id={id}
      className="flex flex-col items-center justify-between p-4 rounded-lg shadow-md border-gray-400 border-1 min-w-3xs"
    >
      <div className="min-w-full font-semibold">{name}</div>
